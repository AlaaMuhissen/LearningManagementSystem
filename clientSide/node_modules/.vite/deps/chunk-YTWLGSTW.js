import {
  useTheme
} from "./chunk-DR5UG2KP.js";
import {
  Transition_default
} from "./chunk-QYWOSCCJ.js";
import {
  require_react_dom
...
function useControllableReducer(parameters) {
  ...
  const controlledPropsRef = React8.useRef(controlledProps);
  if (true) {
    React8.useEffect(() => {
      Object.keys(controlledProps).forEach((key) => {
...
var Portal = React25.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime13.jsx)(React25.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime13.jsx)(React25.Fragment, {
...
var popperClasses = generateUtilityClasses2(COMPONENT_NAME6, ["root"]);
...
var Menu = React27.forwardRef(function Menu2(props, forwardedRef) {
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React28.useContext(DropdownContext);
  if (menuContext === null) {
...
var MenuButton = React29.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    slots = {},
...
function useMenuItem(params) {
  ...
  const itemRef = React30.useRef(null);
  const itemMetadata = React30.useMemo(() => ({
    disabled,
    id: id != null ? id : "",
    label,
    ref: itemRef
  ...
  const {
    dispatch
  } = (_React$useContext = React30.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
function useMenuItemContextStabilizer(id) {
  ...
  const localGetItemState = React31.useCallback((itemValue) => {
    if (itemValue !== itemId) {
  ...
  const localContextValue = React31.useMemo(() => ({
    dispatch,
...
var InnerMenuItem = React32.memo(React32.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled: disabledProp = false,
...
var MenuItem2 = React32.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
function useModal(parameters) {
  ...
  const [exited, setExited] = React33.useState(!open);
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime20.jsx)(React35.Fragment, {
...
function useNumberInput(parameters) {
  ...
  const [dirtyValue, setDirtyValue] = React36.useState(value ? String(value) : void 0);
  React36.useEffect(() => {
...
var popupClasses = generateUtilityClasses2(COMPONENT_NAME13, ["root", "open"]);
...
var TransitionContext = React43.createContext(null);

// ../node_modules/@mui/base/useTransition/useTransitionStateManager.js
function useTransitionStateManager() {
  const transitionContext = React44.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React45.useState(true);
  const hasPendingExitTransition = React45.useRef(false);
  const registeredTransitions = React45.useRef(0);
  const [hasTransition, setHasTransition] = React45.useState(false);
  const previousRequestEnter = React45.useRef(requestEnter);
  React45.useEffect(() => {
  ...
  const handleExited = React45.useCallback(() => {
    hasPendingExitTransition.current = false;
    setExitTransitionFinished(true);
  }, []);
  const registerTransition = React45.useCallback(() => {
...
var PopupContext = React46.createContext(null);
...
var Popup = React47.forwardRef(function Popup2(props, forwardedRef) {
  ...
  const popupContextValue = React47.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
  ...
  return (0, import_jsx_runtime26.jsx)(Portal, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime26.jsx)(PopupContext.Provider, {
      value: popupContextValue,
      children: (0, import_jsx_runtime26.jsx)(TransitionContext.Provider, {
        value: contextValue,
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime28.jsx)(React50.Fragment, {
...
function useSlider(parameters) {
  ...
  const sliderRef = React51.useRef();
  ...
  const previousIndex = React51.useRef();
...
var Slider = React52.forwardRef(function Slider2(props, forwardedRef) {
...
function useSnackbar(parameters = {}) {
  ...
  const handleResume = React53.useCallback(() => {
...
var TextareaAutosize = React70.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime46.jsxs)(React70.Fragment, {
...
function CssAnimation(props) {
  ...
  const hasExited = React71.useRef(true);
  React71.useEffect(() => {
    if (requestedEnter && hasExited.current) {
      hasExited.current = false;
    }
  }, [requestedEnter]);
  const handleAnimationEnd = React71.useCallback((event) => {
...
var CssTransition = React72.forwardRef(function CssTransition2(props, forwardedRef) {
  const {
    children,
    className,
  ...
  const [isEntering, setIsEntering] = React72.useState(false);
  React72.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React72.useCallback((event) => {
...
var Backdrop = React75.forwardRef(function Backdrop2(inProps, ref) {
  ...
  return (0, import_jsx_runtime50.jsx)(TransitionComponent, _extends({
    ...
    children: (0, import_jsx_runtime50.jsx)(BackdropRoot, _extends({
      "aria-hidden": true
    }, rootSlotProps, {
...
var Modal3 = React76.forwardRef(function Modal4(inProps, ref) {
  ...
  return (0, import_jsx_runtime51.jsx)(Portal, {
    ref: portalRef,
    container,
    disablePortal,
    children: (0, import_jsx_runtime52.jsxs)(RootSlot, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime51.jsx)(BackdropSlot, _extends({}, backdropProps)) : null, (0, import_jsx_runtime51.jsx)(FocusTrap, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
        isEnabled: isTopModal,
        open,
        children: React76.cloneElement(children, childProps)
      })]
    }))
  });
});
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YTWLGSTW.js.map
